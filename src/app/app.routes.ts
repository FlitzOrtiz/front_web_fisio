...
import { PoseDetectionComponent } from './game/component/pose-detection/pose-detection.component';
...
export const routes: Routes = [
  ...
  { path: 'exercise/summary', component: ExerciseSummaryComponent },
  {
    ...
    component: LandingSubscriptionSelectorComponent,
  },
  { path: 'legal', component: LegalScreenComponent },
  { path: 'game/pose-detection', component: PoseDetectionComponent },
];
